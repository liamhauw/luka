...
struct DrawElement {
  ...
  PushConstantUniform push_constant_uniform;
};
...
class Subpass {
 public:
  ...
  virtual void UpdatePushConstantUniform(
      const vk::raii::CommandBuffer& command_buffer) = 0;
  void UpdateGlobalUniform(u32 active_frame_index,
