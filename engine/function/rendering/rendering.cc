...
const vk::raii::CommandBuffer& Rendering::Begin() {
  vk::Result result;
...
void Rendering::End(const vk::raii::CommandBuffer& command_buffer) {
  command_buffer.end();
...
void Rendering::TarversePasses(const vk::raii::CommandBuffer& command_buffer) {
...
void Rendering::CreateSyncObjects() {
...
void Rendering::CreateCommandObjects() {
...
void Rendering::CreateViewportAndScissor() {
