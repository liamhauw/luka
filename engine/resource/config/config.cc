...
Config::Config() {
  ...
  std::string texture_name{
      ReplacePathSlash(config_data["asset"]["texture"].get<std::string>())};
  ...
  texture_file_path_ = texture_path_ / texture_name;
}
...
std::filesystem::path Config::GetTextureFileFilePath() {
